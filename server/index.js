...
const huaweiRouter = require("./routes/huawei");
const harmonyTaskRouter = require("./routes/harmonyTask");
...
app.use("/api/pay/huawei", huaweiRouter);
app.use("/api/harmony/task", harmonyTaskRouter);
